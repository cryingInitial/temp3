...
import logging
import numpy as np
from methods.cl_manager_joint import CLManagerJoint
...
class ETF_ER_JOINT(CLManagerJoint):
    ...
    def online_step(self, n_worker):
        self.sample_num+=1
        train_loss, train_acc = self.online_train()
        self.report_training(self.sample_num, train_loss, train_acc)
        if self.sample_num % 100 == 0 and self.sample_num !=0:
            fc_pickle_name = "etf_joint_sigma" + str(self.sigma) + "_num_" + str(self.sample_num) + "_iter" + str(self.online_iter) + "_fc.pickle"
            feature_pickle_name = "etf_joint_sigma" + str(self.sigma) + "_num_" + str(self.sample_num) + "_iter" + str(self.online_iter) + "_feature.pickle"
            class_pickle_name = "etf_joint_sigma" + str(self.sigma) + "_num_" + str(self.sample_num) + "_iter" + str(self.online_iter) + "_class.pickle"
            ...
            self.save_features(feature_pickle_name, class_pickle_name, self.rep_indices)

            pickle_name_feature_std_mean_list = "etf_joint_sigma" + str(self.sigma) + "_num_" + str(self.online_iter) + "_feature_std.pickle"
            pickle_name_stds_list = "etf_joint_sigma" + str(self.sigma) + "_num_" + str(self.online_iter) + "_stds.pickle"
